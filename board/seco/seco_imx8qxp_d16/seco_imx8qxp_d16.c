...
static void board_gpio_init(void)
{
	...
	/* Put in reset eth1 - some conflicts prevent eth1 to work with eth0 */	
...
int board_late_init(void)
{
	...
	if (fdt_file && !strcmp(fdt_file, "undefined")) {
		if (m4_boot)
			env_set("fdt_file", "seco-imx8qxp-d16-rpmsg.dtb");
		else
			env_set("fdt_file", "seco-imx8qxp-d16.dtb");
	}

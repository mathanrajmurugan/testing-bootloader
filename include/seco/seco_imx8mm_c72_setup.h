...
#define C72_IS_1GB	0 /* Fixed value - waiting for right straps */
#define C72_IS_2GB	1 /* Fixed value - waiting for right straps */ 
#define C72_IS_4GB      0 /* Fixed value - waiting for right straps */

...
int selection_video_overlay_files (overlay_struct_mode_t overlay_video_mode_list[], int num_element) {
...
#if !defined CONFIG_TARGET_SECO_IMX8QM_C26 && !defined CONFIG_TARGET_SECO_IMX8QM_C43 && !defined CONFIG_TARGET_SECO_IMX8QXP_D16
	#if defined CONFIG_TARGET_SECO_IMX8MM_C61 
	...
	#elif defined(CONFIG_TARGET_SECO_IMX8QXP_C57)
...
//		size = PHYS_SDRAM_SIZE;
	...
	defined CONFIG_TARGET_SECO_IMX8MM_C61 || defined CONFIG_TARGET_SECO_IMX8QXP_D16
                size = PHYS_DRAM_IS_2GB;
#endif
#if defined CONFIG_TARGET_SECO_IMX8MM_C72 ||  defined CONFIG_TARGET_SECO_IMX8MN_C72 
		if(C72_IS_1GB)
                        size = PHYS_DRAM_IS_1GB;
                if(C72_IS_2GB)
                        size = PHYS_DRAM_IS_2GB;
